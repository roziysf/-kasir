...
<head>
    ...
    <title>Login Aplikasi Kasir | rozikin</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/yoman.jpg" alt="" width="72" height="72">
      ...
      <p class="mt-3 mb-3 text-white">&copy; 2023 Developed by - <a target="_blank" rel="noopener noreferrer" class="text-white">
     rozikin</a></p>
